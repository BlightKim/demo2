...
<div class="container">
  <div class="row input-form-backgroud">
    <div class="col-md-12 mx-auto input-form">
      ...
      <form action="/register/join" method="post" onsubmit="return allCheck();">
        <div class="form-row">
          <div class="col-md-6 mb-3"><label for="userId">아이디</label><input id="userId" name="userId"
                                                                           class="form-control form-control"
                                                                           type="text"/>
            
            <div><span id="id_warning"></span></div>
          </div>
        ...
        <div class="form-row">
          <div class="col-md-6 mb-3"><label for="password1">비밀번호</label><input id="password1"
                                                                               ...
                                                                               placeholder value
                                                                               required/>
            <div id="password1_warning" class="password1_warning" hidden="hidden"><span></span></div>
          </div>
        </div>
        <div class="form-row">
          <div class="col-md-6 mb-3"><label for="password2">비밀번호 재확인</label><input id="password2"
                                                                                   ...
                                                                                   type="password"
                                                                                   placeholder/>
            <div id="password2_warning" class="password2_warning"><span></span></div>
          </div>
        </div>
        <div class="form-row">
          <div class="col-md-6 mb-3"><label for="userName">이름</label><input id="userName"
                                                                            ...
                                                                            type="text"
                                                                            placeholder/>
            <div class="userName_warning" id="userName_warning" hidden=""><span> 이름을 입력해주세요. </span></div>
          </div>
        </div>
        <div class="form-row">
          <div class="col-md-6 mb-3"><label for="cellphone">전화번호</label><input id="cellphone"
                                                                               name="cellphone"
                                                                               class="form-control form-control"
                                                                               type="tel"
                                                                               placeholder/>
            <div id="cellphone_warning" hidden="hidden"><span></span></div>
          </div>
        </div>
        <div class="mb-3"><label>성별</label>
          <div class="form-check"><input name="gender" id="man" class="form-check-input" type="radio" value="0"/><label
            class="form-check-label" for="man">남</label></div>
          <div class="form-check"><input name="gender" id="woman" class="form-check-input" type="radio"
                                         value="1"/><label class="form-check-label" for="woman">여</label></div>
          <div id="gender_warning" hidden="hidden"><span></span></div>
        </div>
        <div class="mb-3"><label for="Email">이메일</label><input id="email" name="email"
                                                               class="form-control form-control"
                                                               type="email"
                                                               placeholder="you@example.com"
                                                               required/>
          <div class="email_warning" id="email_warning" hidden="hidden"><span></span></div>
        </div>
        <div class="form-row">
          <div class="col-md-6 mb-3"><label>생년월일</label>
            ...
            <div class="birth_warning" id="birth-warning"><span></span></div>
          </div>
        </div>
        <div class="form-row">
          <div class="col-md-6 mb-3"><label for="introduction">자기소개</label>
            ...
            <div id="introduction_warning"><span></span></div>
          </div>
        </div>
        ...
        <div class="mb-4"></div>
        <button class="btn btn-primary btn-block btn-lg" type="submit" id="submit_btn">가입 완료</button>
      </form>
    </div>
  </div>
...
<script>
    ...
    let idChk = false, pwd1Chk = false, pwd2Chk = false, nameChk = false, cellphoneChk = false,
        genderChk = false, emailChk = false, birthChk = false, introductionChk = false, addressChk = false, getherChk = false;
